    ...
    <div style={{ padding: '30px', fontFamily: 'Arial' }}>
      ...
      <form onSubmit={handleAdd} style={{ marginBottom: '30px', display: 'flex', gap: '10px' }}>
        ...
        <input
          ...
          required
        />
        <button type="submit" style={{ padding: '8px 15px', backgroundColor: '#28a745', color: '#fff', border: 'none' }}>
          Add
        </button>
      </form>
      ...
      {editProduct && (
        <form onSubmit={handleUpdate} style={{ marginBottom: '30px', display: 'flex', gap: '10px' }}>
          ...
          <input
            ...
            required
          />
          <button type="submit" style={{ padding: '8px 15px', backgroundColor: '#007bff', color: '#fff', border: 'none' }}>
            Update
          </button>
          <button
            type="button"
